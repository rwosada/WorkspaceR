...
# 자동으로 사용되는 장치를 의미한다.
#
# stdout( 표준 출력장치 ) : 모니터  // 미리 지정하지 않으면 무조건 표준 출력 장치로 출력된다.
# stdin( 표준 입력 장치 ) : 키보드
...
#
# Vector( 벡터 ) : 동일 자료형 값의 집합 ex) 10명의 R과목 점수 저장
